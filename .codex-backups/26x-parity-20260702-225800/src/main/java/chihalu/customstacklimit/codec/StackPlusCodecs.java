...
/**
 * vanillaの保存用ItemStack CODECに残る99個制限を1000個対応へ拡張します。
 */
public final class StackPlusCodecs {
    public static final MapCodec<ItemStack> ITEM_STACK_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            ExtraCodecs.optionalAlwaysPresentFieldOf(ExtraCodecs.intRange(1, StackLimitConfig.getStackLimit()), "count", 1)
