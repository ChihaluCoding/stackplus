...
public class StackPlusConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (pendingStackLimitPresetsVisible) {
            ...
            context.drawTextWithShadow(this.textRenderer, Text.literal((currentPage + 1) + "/" + pageCount), left + 60, layout.presetLabelY(), 0xFFB8B8B8);
        }
    ...
    private static void renderPanel(DrawContext context, int x, int y, int width, int height) {
        ...
        context.fill(x, y, x + width, y + 1, PANEL_BORDER_COLOR); context.fill(x, y + height - 1, x + width, y + height, PANEL_BORDER_COLOR); context.fill(x, y, x + 1, y + height, PANEL_BORDER_COLOR); context.fill(x + width - 1, y, x + width, y + height, PANEL_BORDER_COLOR);
    }
