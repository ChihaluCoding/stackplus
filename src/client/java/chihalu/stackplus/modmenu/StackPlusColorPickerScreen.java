...
final class StackPlusColorPickerScreen extends Screen {
    ...
    private Identifier wheelTextureId;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        int centerX = this.width / 2;
        int centerY = getWheelCenterY();
        if (wheelTextureId != null) {
            context.drawTexture(wheelTextureId, centerX - WHEEL_RADIUS, centerY - WHEEL_RADIUS,
                    WHEEL_SIZE, WHEEL_SIZE, 0.0F, 0.0F,
    ...
    public void close() {
        if (wheelTextureId != null) {
            MinecraftClient.getInstance().getTextureManager().destroyTexture(wheelTextureId);
            wheelTextureId = null;
        }
    ...
    private void createWheelTexture() {
        ...
        wheelTextureId = MinecraftClient.getInstance().getTextureManager()
                .registerDynamicTexture("stackplus_color_wheel", texture);
    }
